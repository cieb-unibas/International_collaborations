...
################################################################################
  ...
  forcit_data2 <-subset(forcit_data, select = c("p_key","pub_nbr_oecd", "world_class_90", "world_class_99"))
  colnames(forcit_data2) <- c("p_key", "patent_id", "world_class_90", "world_class_99")
